  ...
  return (
    <html lang="km" className="h-full">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Battambang:wght@400;700;900&family=Fredoka:wght@400;500;600;700&family=Kantumruy+Pro:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Noto+Sans+Khmer:wght@400;500;600;700&display=swap"
          rel="stylesheet"
        />
      </head>
